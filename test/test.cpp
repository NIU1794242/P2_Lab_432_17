...
bool test()
{
    ...
    // 2. getCell y setCell en caso válido
    {
        ...
        if (b.getCell(0, 0)->getType() != red.getType())
        {
            std::cout << "Error en setCell/getCell en (0,0)" << std::endl;
            ok = false;
        }

        if (b.getCell(2, 1)->getType() != blue.getType())
        {
    ...
    // 3. Casos inválidos de getCell y setCell
    {
        ...
        if (b.getCell(0, 0)->getType() != orange.getType())
        {
    ...
    // 9. explodeAndDrop cuando no hay explosión
    {
        ...
        if (b.getCell(0, 0)->getType() != red.getType() || b.getCell(2, 2)->getType() != blue.getType())
        {
    ...
    // 10. explodeAndDrop simple con caída
    {
        ...
        if (b.getCell(1, 3)->getType() != blue.getType())
        {
...
/*
        ...
        TESTS CON SHALLOW COPY EN SETCELL
